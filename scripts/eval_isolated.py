...
parser.add_argument("--task", type=str, default="RMA-Go2-Teacher-Rough-NA", help="Registered task name.")
...
parser.add_argument("--latent-mode", type=str, default="normal", choices=["normal", "zero", "shuffled"])
...
def main() -> None:
    ...
    if json_out is None:
        ...
        json_out = str(Path("artifacts/evaluations") / f"isolated_{ckpt}_{suffix}_{args_cli.latent_mode}_seed{args_cli.seed}.json")
