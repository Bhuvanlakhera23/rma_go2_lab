...
DEFAULT_CHECKPOINT = Path(
    "/home/bhuvan/projects/rma/rma_go2_lab/rma_go2_lab/policies/rough_teacher_v2_refined_240.pt"
)
...
def scenario_set(name: str) -> list[Scenario]:
    ...
    if name == "latent_ablation":
        return [
            Scenario("latent_normal", latent_mode="normal"),
            Scenario("latent_zero", latent_mode="zero"),
            Scenario("latent_shuffled", latent_mode="shuffled"),
        ]
    if name == "complete_teacher":
        return [
            Scenario("nominal_random_rough_l9", terrain_type="random_rough", terrain_level=9),
            Scenario("nominal_stairs_up_l9", terrain_type="pyramid_stairs", terrain_level=9),
            Scenario("nominal_stairs_down_l9", terrain_type="pyramid_stairs_inv", terrain_level=9),
            Scenario("nominal_boxes_l9", terrain_type="boxes", terrain_level=9),
            Scenario("fric_min_random_rough_l9", terrain_type="random_rough", terrain_level=9, static_friction=0.1, dynamic_friction=0.1),
            Scenario("fric_max_random_rough_l9", terrain_type="random_rough", terrain_level=9, static_friction=2.0, dynamic_friction=2.0),
            Scenario("mass_min_random_rough_l9", terrain_type="random_rough", terrain_level=9, mass_offset=-2.0),
            Scenario("mass_max_random_rough_l9", terrain_type="random_rough", terrain_level=9, mass_offset=4.0),
            Scenario("motor_min_random_rough_l9", terrain_type="random_rough", terrain_level=9, motor_stiffness_scale=0.6, motor_damping_scale=0.6),
            Scenario("motor_max_random_rough_l9", terrain_type="random_rough", terrain_level=9, motor_stiffness_scale=1.4, motor_damping_scale=1.4),
            Scenario("combined_low_grip_heavy_weak_stairs_up_l9", terrain_type="pyramid_stairs", terrain_level=9, static_friction=0.1, dynamic_friction=0.1, mass_offset=4.0, motor_stiffness_scale=0.6, motor_damping_scale=0.6),
            Scenario("combined_high_grip_heavy_strong_stairs_down_l9", terrain_type="pyramid_stairs_inv", terrain_level=9, static_friction=2.0, dynamic_friction=2.0, mass_offset=4.0, motor_stiffness_scale=1.4, motor_damping_scale=1.4),
            Scenario("latent_zero_random_rough_l9", terrain_type="random_rough", terrain_level=9, latent_mode="zero"),
            Scenario("latent_shuffled_random_rough_l9", terrain_type="random_rough", terrain_level=9, latent_mode="shuffled"),
            Scenario("latent_zero_stairs_up_l9", terrain_type="pyramid_stairs", terrain_level=9, latent_mode="zero"),
            Scenario("latent_shuffled_stairs_up_l9", terrain_type="pyramid_stairs", terrain_level=9, latent_mode="shuffled"),
        ]
    return [
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--task", default="RMA-Go2-Teacher-Rough-NA")
    ...
    parser.add_argument("--latent-mode", default="normal", choices=["normal", "zero", "shuffled"])
    parser.add_argument(
        "--suite",
...
def main() -> int:
    ...
    for idx, scenario in enumerate(scenarios, start=1):
        ...
        proc = subprocess.run(cmd, cwd=Path(__file__).resolve().parents[1], env=child_env)
